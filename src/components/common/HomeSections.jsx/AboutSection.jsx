...
export default function AboutSection() {
  return (
    <section id="about" className="relative py-16 sm:py-20 lg:py-24 bg-slate-50/70 w-full overflow-x-hidden">
    
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-125 h-125 max-w-full bg-purple-400/10 blur-[150px] rounded-full -z-10 pointer-events-none" />
